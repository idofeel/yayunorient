 ...
 * --------------------------------------------------------------------------------
 * boundary    |    Boolean     |     true      |     可选参数 设置图片拖动到边界时是否允许继续拖动
 * uri         |    String      |     ''        |     * 必填 图片的地址
...
export default class extends React.Component {
    constructor(props) {
        ...
        this.bounding = props.bounding === undefined ? false : props.bounding; //设置是否允许边界
        ...
        return (
            <div ref="visivbleArea" className="visivbleArea"
                ...
                <div ref="imgContainer"
                    ...
                    style={pictrueStyle}>
                    {/* 缩略图 */}
                    <img src={uri || require('../../assets/images/2.jpg')} alt="" draggable={false} />
